...
const translations = {
  en: {
    ...
    results: "Results",
    onHillSportCategory: "Running apparel and weighted accessories",
    onHillSportCampaign: "Lifestyle reel / product integration",
    onHillSportResults: "10.7% engagement rate • 20+ direct product inquiries",
    ...
    keybellCategory: "Accessories brand",
    keybellCampaign: "Custom product feature / bio traffic",
    keybellResults: "20% bio link CTR • 340 saves",
    ...
    rebootResults: "50% engagement rate • 420 saves",
  ...
  ru: {
    ...
    rebootResults: "50% engagement rate • 420 сохранений",
  ...
  fr: {
    ...
    rebootResults: "50% engagement rate • 420 enregistrements",
    ...
    monthlyReachValue: "3.1M+ portée mensuelle",
  ...
  es: {
    ...
    rebootResults: "50% engagement rate • 420 guardados",
    ...
    monthlyReachValue: "3.1M+ alcance mensual",
  ...
  ar: {
    ...
    monthlyReachValue: "3.1M+ وصول شهري",
